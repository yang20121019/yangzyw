...
export const Banner30DataSource = {
  wrapper: { className: 'banner3 m59hf85z83q-editor_css' },
  textWrapper: {
    ...
    children: [
      ...
      {
        name: 'name',
        className: 'banner3-name m59hfbezy4-editor_css',
        children: (
          <span>
            <span>
              <span>
      ...
      {
        name: 'time',
        className: 'banner3-time m59hdy14ysc-editor_css',
        children: (
          <span>
            2024年创建<br />
          </span>
      ...
      {
        name: 'button',
        className: 'banner3-button m59hhkq2qwj-editor_css',
        children: (
          <span>
            主站<br />
          </span>
      ...
      {
        name: 'button~m59in72q37',
        className: 'banner3-button m59ilt0e9t-editor_css',
        children: (
          <span>
            个人博客（旗下网站）<br />
          </span>
        ),
        href: 'http://yangzs.us.kg/',
        target: '_blank',
      },
      {
        name: 'button~m59ioxr91s',
        className: 'banner3-button m59ikv0dom-editor_css',
        children: (
          <span>
            <p>
              教程站（旗下网站）<br />
        ...
        href: 'https://yang20121019.github.io/',
        target: '_blank',
      },
    ],
  },
    ...
    children: [
      {
        ...
        titleWrapper: {
          ...
          children: [
            {
              name: 'image',
              children: 'https://oax.wzznft.com/i/2024/12/29/u9s7n2.jpg',
